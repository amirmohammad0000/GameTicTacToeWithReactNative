...
import { styles } from "./Css/CssGameWithComputer";
/////////////////////////////////////////////////////////////////////////////////////// End Section Import

/////////////////////////////////////////////////////////////////////////////////////// Start Section Class
export default class GameWithComputer extends React.Component {
  // Start Section State
  state = {
    TextButtonOne: "",
    TextButtonTwo: "",
  ...
  FuncSetIfGameComputer() {
    if (this.state.TextButtonOne === "") {
      if (
        this.state.StatePlayerX === false &&
        this.state.StatePlayerO === true
      ) {
        this.setState({
          StatePlayerX: true,
          StatePlayerO: false,
    ...
    } else if (this.state.TextButtonTwo === "") {
      if (
        this.state.StatePlayerX === false &&
        this.state.StatePlayerO === true
      ) {
    ...
    } else if (this.state.TextButtonThree === "") {
      if (
        this.state.StatePlayerX === false &&
        this.state.StatePlayerO === true
      ) {
    ...
    } else if (this.state.TextButtonFour === "") {
      if (
        this.state.StatePlayerX === false &&
        this.state.StatePlayerO === true
      ) {
    ...
    } else if (this.state.TextButtonFive === "") {
      if (
        this.state.StatePlayerX === false &&
        this.state.StatePlayerO === true
      ) {
    ...
    } else if (this.state.TextButtonSix === "") {
      if (
        this.state.StatePlayerX === false &&
        this.state.StatePlayerO === true
      ) {
    ...
    } else if (this.state.TextButtonSeven === "") {
      if (
        this.state.StatePlayerX === false &&
        this.state.StatePlayerO === true
      ) {
    ...
    } else if (this.state.TextButtonEight === "") {
      if (
        this.state.StatePlayerX === false &&
        this.state.StatePlayerO === true
      ) {
    ...
    } else if (this.state.TextButtonNine === "") {
      if (
        this.state.StatePlayerX === false &&
        this.state.StatePlayerO === true
      ) {
